...
Android cloud backup and device transfer are disabled for version 1. Version 0.5.4
...
Version 0.5.4 uses MapLibre with OpenFreeMap vector tiles styled in the Ovayuva
