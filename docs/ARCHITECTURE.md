...
Android cloud backup and device transfer are disabled for version 1. Version 0.4.3
...
Version 0.4.3 uses MapLibre with OpenFreeMap vector tiles styled in the Ovayuva
